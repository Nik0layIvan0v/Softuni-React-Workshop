        ...
        <div id="home-page">
          ...
          <div className="game">
            ...
            <div className="data-buttons">
              <a href="index.html" className="btn details-btn">
                Details
              </a>
            </div>
          </div>
      ...
      <section id="login-page" className="auth">
        <form id="login">
          <div className="container">
            ...
            <p className="field">
              <span>
                If you don't have profile click <a href="index.html">here</a>
              </span>
            </p>
          </div>
        </form>
      ...
      <section id="register-page" className="content auth">
        <form id="register">
          <div className="container">
            ...
            <p className="field">
              <span>
                If you already have profile click <a href="index.html">here</a>
              </span>
            </p>
          </div>
        </form>
      ...
      <section id="game-details">
        ...
        <div className="info-section">
          <div className="game-header">
            <img alt="" className="game-img" src="images/MineCraft.png" />
            <h1>Bright</h1>
      ...
      <section id="catalog-page">
        ...
        <div className="allGames">
          <div className="allGames-info">
            ...
            <h6>Action</h6>
            <h2>Cover Fire</h2>
            <a href="index.html" className="details-button">
              Details
            </a>
          </div>
        </div>
